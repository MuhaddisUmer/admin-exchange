...
[<img src="./github-assets/html.png" width="60" height="60" />](https://bitdandy.com/product/black-dashboard)
[<img src="./github-assets/react.svg" width="60" height="60" />](https://bitdandy.com/product/black-dashboard-react)[<img src="./github-assets/vuejs.png" width="60" height="60" />](https://bitdandy.com/product/vue-black-dashboard)


| HTML | React | Vue |
| --- | --- | --- |
| [![Black Dashboard HTML](https://s3.amazonaws.com/creativetim_bucket/products/93/thumb/opt_bd_thumbnail.jpg)](https://bitdandy.com/product/black-dashboard) | [![Black Dashboard React](https://s3.amazonaws.com/creativetim_bucket/products/136/thumb/opt_bd_react.jpg)](https://bitdandy.com/product/black-dashboard-react) | [![Vue Black Dashboard](https://s3.amazonaws.com/creativetim_bucket/products/99/thumb/opt_bd_vue_thumbnail.jpg)](https://bitdandy.com/product/vue-black-dashboard) |
...
- [Download from bitdandy](https://bitdandy.com/product/black-dashboard-react).
...
- Download Page: https://bitdandy.com/product/black-dashboard-react
- Documentation: https://demos.creative-tim.com/black-dashboard-react/#/documentation/tutorial
- License Agreement: https://bitdandy.com/license
- Support: https://bitdandy.com/contact-us
...
1. Make sure that you are using the latest version of the Black Dashboard React. Check the CHANGELOG from your dashboard on our [website](https://bitdandy.com/).
2. Providing us reproducible steps for the issue will shorten the time it takes for it to be fixed.
3. Some issues may be browser specific, so specifying in what browser you encountered the issue might help.

## Technical Support or Questions

If you have questions or need help integrating the product please [contact us](https://bitdandy.com/contact-us) instead of opening an issue.

## Licensing

- Copyright 2018 bitdandy (https://www.creative-tim.com)
- Licensed under MIT (https://github.com/creativetimofficial/black-dashboard-react/blob/master/LICENSE.md)

## Useful Links

More products from bitdandy: <https://bitdandy.com/products>

Tutorials: <https://www.youtube.com/channel/UCVyTG4sCw-rOvB9oHkzZD1w>

Freebies: <https://bitdandy.com/products>

Affiliate Program (earn money): <https://bitdandy.com/affiliates/new>
